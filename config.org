...
- [[#system][System]]
  ...
  - [[#troubleshoot][Troubleshoot]]
    ...
    - [[#github-remote-ssh-always-ask-for-password][Github remote SSH always ask for password]]
...
- [[#modules][Modules]]
  ...
  - [[#programming-language][Programming Language]]
    ...
    - [[#web][Web]]
    - [[#org-mode][Org-Mode]]
  - [[#email--accounts-email][Email & Accounts :email:]]
...
#+end_src
*** Github remote SSH always ask for password
...
: default, light, dark, custom, auto
...
+ src_elisp{'auto} mode is the automatic theme switching. If auto mode was set,
 ~doom-theme~ will be set to the ~light~ or ~dark~ theme according to the hour
 in the current time, ~light-theme-begin~ and ~light-theme-end~.
...
** Email & Accounts :email: :email:mu4e:
