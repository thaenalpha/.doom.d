...
+ corfu/
  #+name: autoload.el
  #+begin_src emacs-lisp :tangle modules/completion/corfu/autoload.el :mkdirp yes
...
(use-package! corfu
  ...
  (when (featurep! :editor evil)
    ...
    (add-hook! 'evil-normal-state-entry-hook
      (defun +corfu-quit-h () (when corfu--candidates (corfu-quit))))
    (map! (:map corfu-map
           "C-n"    #'corfu-next
           "C-p"    #'corfu-previous
           "C-j"    #'corfu-next
  ...
  (after! eldoc
    (eldoc-add-command 'corfu-complete
                       'corfu-insert
                       'completion-at-point
                       'corfu-abort)))
...
(use-package! cape
  ...
  (add-to-list
   ...
   (cape-super-capf #'cape-file #'cape-dabbrev #'cape-keyword #'cape-symbol
                    #'+cape/yasnippet))
  <<tabnine>>)
...
(unless (featurep! :completion company) (package! company))
  #+end_src
  #+name: README.org
  #+begin_src org :tangle modules/completion/corfu/README.org :noweb no-export
...
+ =+tabnine= use Tabnine code completion for backend
...
+ tab-workspaces/
  #+name: README.org
  #+begin_src emacs-lisp :tangle modules/ui/tab-workspaces/README.org :mkdirp yes
...
+ tree-sitter/
  #+name: README.org
  #+begin_src emacs-lisp :tangle modules/tools/tree-sitter/README.org :mkdirp yes
